...
export default async function NewProposalPage({ searchParams }: { searchParams: { orgId?: string } }) {
  ...
  return (
    <div className="p-8 max-w-3xl">
      ...
      <ProposalBuilder clientOrgs={clients} defaultOrgId={searchParams.orgId} />
    </div>
  );
}
